...
\textbf{Analyse}: Die Skalierung zeigt deutliche Vorteile der Parallelisierung. Durch die Optimierung auf Spark Core (ohne SQL-Overhead) konnte der Speedup von 3,2x auf 4,1x gesteigert werden. Die Laufzeit auf 8 Kernen sank von ca. 19s auf 13,5s. Der Speedup ist nicht perfekt linear, da:
\begin{itemize}
