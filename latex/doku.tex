...
\textbf{Interpretation:} Russisch zeigt die höchste sprachliche Vielfalt (TTR = 0,29). Französisch und Englisch haben niedrigere TTR-Werte (ca. 0,03).
...
\begin{itemize}
    \item \textbf{Stoppwort-Filter}: Für jede Sprache wurden die entsprechenden Stoppwort-Listen geladen. Der Filter wurde korrekt angewandt.
...
\begin{itemize}
    \item Alle 8 Sprachen wurden erkannt und verarbeitet
    \item TTR-Werte liegen im erwarteten Bereich <1,0
...
\textbf{Analyse}: Die Skalierung zeigt deutliche Vorteile der Parallelisierung. Die Laufzeit auf 8 Kernen sank auf ca. 12,3s. Der Speedup ist nicht perfekt linear, da:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Die Parallelisierung zeigt mit 8 Kernen einen Speedup von 4,7x gegenüber sequentieller Verarbeitung.
