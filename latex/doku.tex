...
Der Code ist auf GitHub verfügbar: \url{https://github.com/justingebert/spark-benchmarking}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{images/flow_diagram.png}
...
\begin{itemize}
    ...
    \item \textbf{Datensatz}: Original (134 MB, 363 Dateien), Medium (672 MB, 1815 Dateien) und Large (2,6 GB, 6045 Dateien)
